...
$summary = (object) $bank->Summary();
$eligi = $bank->Eligiblebanks();
?>
                ...
                <div class="card backdrop">
                    <div class="card-body">
                        ...
                        <div class="card cx-card text-left p-3">
                            <h5 class="card-title cx-t-1"><?php echo $config['bank']['account_number'] ?></h5>
                            <p class="cx-w pt-0"><?php echo $summary->result['totalAvailableBalance']?> บาท</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body ">
                    ...
                    <div class="d-inline-flex">
                        <div class="row pl-3 pr-3 pt-2">
                            <?php
                            if ($eligi['error']['code'] !== 100 ) {
                                echo '<h5 class="card-title">เกิดข้อผิดพลาด f5</h5>';
                                return;
                            }
                            foreach ($eligi['result']['data'] as $v) {
                                # code...
